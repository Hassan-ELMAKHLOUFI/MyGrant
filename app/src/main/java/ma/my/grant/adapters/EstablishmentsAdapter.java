...
public class EstablishmentsAdapter extends RecyclerView.Adapter<EstablishmentsAdapter.ViewHolder> {
    ...
    public EstablishmentsAdapter(Context context, List<Establishment> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_establishment, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Establishment element = list.get(position);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final Context context, View itemView) {
            ...
            delete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Establishment element = (Establishment) view.getTag();
        ...
        public void deleteElement(final Establishment element) {
            try {
                String query = "DELETE FROM establishments WHERE id_e = ?";
